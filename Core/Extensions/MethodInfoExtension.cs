...
namespace Config.Core.Extensions
{
    ...
    {
        public static object InvokeStatic(this MethodInfo myMethod)
        {
            return myMethod.Invoke(null, new object[] { });
        }

        public static object InvokeStatic(this MethodInfo myMethod, params object[] myParams)
        {
            return myMethod.Invoke(null, myParams);
        }
    }
}
