...
namespace Config.Core.Extensions
{
    public static class AutoResetEventExtension
    {
        ...
        ///// <returns></returns>
        //public static bool WaitWithEvents(this System.Threading.AutoResetEvent mre, int eventDelayInMilliseconds)
        //{
        ...
        ///// <param name="eventDelayInMilliseconds"></param>
        ///// <returns></returns>
        //public static bool WaitWithEvents(this System.Threading.AutoResetEvent mre, int delayInMilliseconds, int eventDelayInMilliseconds)
        //{
        //    int waitCount = delayInMilliseconds / 10;
        ...
        //            if (delayInMilliseconds != Timeout.Infinite && ts.TotalMilliseconds > delayInMilliseconds)
        //                break;
        //            else
        //                WpfHelp.DoEvents();
        //        }
        ...
        /// <returns></returns>
        public static bool WaitAndTest(this System.Threading.AutoResetEvent resEv, int intervalInMilliseconds, Func<bool> func)
        {
            //bool retval = false;
            //bool result = false;
            //do
        ...
        /// <param name="func"></param>
        /// <returns></returns>
        public static bool WaitAndTest(this System.Threading.AutoResetEvent mre, int totalWaitInMilliseconds, int intervalInMilliseconds, Func<bool> func)
        {
            ...
            while (!waitDone)
            {
                if (myThread.IsAlive && mre.WaitOne(intervalInMilliseconds))
                    break;
